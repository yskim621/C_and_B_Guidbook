...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //어댑터 생성
        CardAdapter adapter = new CardAdapter(this, trumpcard);
        ...
        //어댑터 생성
        adapter = new CardAdapter(this, boardgame);
